"""
URL configuration for multibpreneur_website project.
...
router.register(r'api/posts', BlogPostViewSet)
router.register(r'api/business-inquiries', BusinessInquiryViewSet)
